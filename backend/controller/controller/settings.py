...
SECRET_KEY = 'django-insecure-et%p9jggbdji*5o3gaqnw-2@mhser^m()nz_md8epd273=6&+p'
...
# Optionally, you can specify additional headers to be allowed
CORS_ALLOW_HEADERS = list(default_headers) + [
    'X-CSRFToken',  # Include any custom headers you may need
]
...
# Optional: If you're using HTTPS in production, set this to True
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'ssl': {
                'ca': os.environ.get('AZURE_SSL_CA_PATH'),
                'ssl_disabled': False,
            },
        },
    }
