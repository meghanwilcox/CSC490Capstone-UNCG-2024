...
from .views import UsersListView, CreateUserView, UserLoginView, SpeciesListView, SpeciesDataView, AdminLoginView, UpdateUserProfileView, AddSightingView, SightingListView, IsAuthenticatedView
